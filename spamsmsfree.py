...
\033[1;33m╔══════════════════════════════════════════════════════╗
\033[1;33m║\033[1;31m © Tool Make By New Bie(NC Hoài)                                                              
\033[1;33m║\033[1;32m Admin: NC Hoài                                                                                       
\033[1;33m║\033[1;32m Tool spam sms + call    
\033[1;33m║\033[1;32m Lưu ý: Sử dụng với mục đích giải trí troll 
\033[1;33m║\033[1;32m bạn bè không sử dụng với mục đích vi phạm pháp 
\033[1;33m║\033[1;32m luật, các hành vi vi phạm sẽ chịu trách nhiệm
\033[1;33m║\033[1;32m trước pháp luật!                                                                                                   
\033[1;33m╚══════════════════════════════════════════════════════╝
"""
    for x in banner:
        sys.stdout.write(x)
...
banner()
# print('─'*50)
sdt = input(f'Nhập sdt nạn nhân: ')
if sdt == '0976440304':
    print(f'Số Này Không Thể Spam !!!')
    quit()
spam = int(input(f'Số lần spam: '))
...
def tv360(sdt):
    ...
    if response ['errorCode'] == 200:
        print(f'[NC Hoài] ~ \033[1;35m TV360 SPAM THÀNH CÔNG')
    else:
        print(f'[NC Hoài] ~ \033[1;35m TV360 SPAM THẤT BẠI')
def hoangphuc(sdt):
    headers = {
    ...
    if response ['success'] == True:
        print(f'[NC Hoài] ~ \033[1;35m HOÀNG PHÚC SPAM THÀNH CÔNG')
    else:
        print(f'[NC Hoài] ~ \033[1;35m HOÀNG PHÚC SPAM THẤT BẠI')
...
def fmplus(sdt):
    ...
    if response ['Code'] == 200:
        print(f'[NC Hoài] ~ \033[1;35m FMPLUS SPAM THÀNH CÔNG')
    else:
        print(f'[NC Hoài] ~ \033[1;35m FMPLUS SPAM THẤT BẠI')
...
def winmart(sdt):
    ...
    try:
        if response ['code'] == 'S200':
            print(f'[NC Hoài] ~ \033[1;35m WINMART SPAM THÀNH CÔNG')
        else:
            print(f'[NC Hoài] ~ \033[1;35m WINMART SPAM THẤT BẠI')
    except:
        print(f'[NC Hoài] ~ \033[1;35m WINMART SPAM THẤT BẠI')
...
def gateway(sdt):
    ...
    if response ['code'] == 200:
        print(f'[NC Hoài] ~ \033[1;35m GHN SPAM THÀNH CÔNG')
    else:
        print(f'[NC Hoài] ~ \033[1;35m GHN SPAM THẤT BẠI')
def hine(sdt):
    headers = {
    ...
    if response ['success'] == True:
        print(f'[NC Hoài] ~ \033[1;35m 30SHINE SPAM THÀNH CÔNG')
    else:
        print(f'[NC Hoài] ~ \033[1;35m 30SHINE SPAM THẤT BẠI')
...
def medicare(sdt):
    ...
    try:
        if response ['error_code'] == 'fail':
            print(f'[NC Hoài] ~ \033[1;35m MEDICARE SPAM THẤT BẠI')
        else:
            print(f'[NC Hoài] ~ \033[1;35m MEDICARE SPAM THÀNH CÔNG')
    except:
        print(f'[NC Hoài] ~ \033[1;35m MEDICARE SPAM THÀNH CÔNG')
...
def batdongsan(sdt):
    ...
    try:
        if response ['data'] == 'success':
            print(f'[NC Hoài] ~ \033[1;35m BATDONGSAN SPAM THÀNH CÔNG')
        else:
            print(f'[NC Hoài] ~ \033[1;35m BATDONGSAN SPAM THẤT BẠI')
    except:
        print(f'[NC Hoài] ~ \033[1;35m BATDONGSAN SPAM THẤT BẠI')
...
def tokyolife(sdt):
    ...
    if response ['success'] == True:
        print(f'[NC Hoài] ~ \033[1;35m TOKYOLIFE SPAM THÀNH CÔNG')
    else:
        print(f'[NC Hoài] ~ \033[1;35m TOKYOLIFE SPAM THẤT BẠI')
...
def futabus(sdt):
    ...
    if response ['message'] == 'OK':
        print(f'[NC Hoài] ~ \033[1;35m FUTABUS SPAM THÀNH CÔNG')
    else:
        print(f'[NC Hoài] ~ \033[1;35m FUTABUS SPAM THẤT BẠI')
...
def thegioididong(sdt):
    ...
    if response ['statusCode'] == 200:
        print(f'[NC Hoài] ~ \033[1;35m TGDĐ SPAM THÀNH CÔNG')
    else:
        print(f'[NC Hoài] ~ \033[1;35m TGDĐ SPAM THẤT BẠI')
...
def kingfoodmart(sdt):
    ...
    if data2 == None:
        print(f'[NC Hoài] ~ \033[1;35m KINGFOO SPAM THẤT BẠI')
    else:
        print(f'[NC Hoài] ~ \033[1;35m KINGFOO SPAM THÀNH CÔNG')
...
def lottemart(sdt): # API lottemart CALL
    ...
    try:
        if response ['error'] == '':
            print("[NC Hoài] ~ \033[1;35m LOTTEMART SPAM THÀNH CÔNG")
        else:
            print("[NC Hoài] ~ \033[1;35m LOTTEMART SPAM THẤT BẠI")
    except:
        print("[NC Hoài] ~ \033[1;35m LOTTEMART SPAM THẤT BẠI")
...
def dienmayxanh(sdt):
    ...
    # print(response)
    if response ['statusCode'] == 200:
        print("[NC Hoài] ~ \033[1;35m ĐMX SPAM THÀNH CÔNG")
    else:
        print("[NC Hoài] ~ \033[1;35m ĐMX SPAM THẤT BẠI")
...
def reebok(sdt):
    ...
    try:
        if response ['statusCode'] == 400:
            print(f'[NC Hoài] ~ \033[1;35m REEBOK SPAM THẤT BẠI')
        else:
            print(f'[NC Hoài] ~ \033[1;35m REEBOK SPAM THÀNH CÔNG')
    except:
        print(f'[NC Hoài] ~ \033[1;35m REEBOK SPAM THÀNH CÔNG')
...
def glxplay(sdt):
    ...
    try:
        if response ['statusCode'] == 400:
            print(f'[NC Hoài] ~ \033[1;35m GALAXY SPAM THẤT BẠI')
        else:
            print(f'[NC Hoài] ~ \033[1;35m GALAXY SPAM THÀNH CÔNG')
    except:
        print(f'[NC Hoài] ~ \033[1;35m GALAXY SPAM THÀNH CÔNG')
...
def fahasa(sdt):
    ...
    try:
        if response ['success'] == True:
            print(f'[NC Hoài] ~ \033[1;35m FAHASA SPAM THÀNH CÔNG')
        else:
            print(f'[NC Hoài] ~ \033[1;35m FAHASA SPAM THẤT BẠI')
    except:
        print(f'[NC Hoài] ~ \033[1;35m FAHASA SPAM THẤT BẠI')
...
def nhathuoclongchau(sdt):
    ...
    try:
        ...
        if chi_mum == None:
            print(f'[NC Hoài] ~ \033[1;35m NTLC SPAM THẤT BẠI')
        else:
            print(f'[NC Hoài] ~ \033[1;35m NTLC SPAM THÀNH CÔNG')
    except:
        print(f'[NC Hoài] ~ \033[1;35m NTLC SPAM THÀNH CÔNG')
...
def fptshop(sdt):
    ...
    try:
        chi_mum = response['error']['details']
        if chi_mum == None:
            print(f'[NC Hoài] ~ \033[1;35m FPTSHOP SPAM THẤT BẠI')
        else:
            print(f'[NC Hoài] ~ \033[1;35m FPTSHOP SPAM THÀNH CÔNG')
    except:
        print(f'[NC Hoài] ~ \033[1;35m FPTSHOP SPAM THÀNH CÔNG')
...
def gumac(sdt):
    ...
    try:
        ...
        if data_cm == '':
            print(f'[NC Hoài] ~ \033[1;35m GUMAC SPAM THÀNH CÔNG')
        else:
            print(f'[NC Hoài] ~ \033[1;35m GUMAC SPAM THẤT BẠI')
    except:
        print(f'[NC Hoài] ~ \033[1;35m GUMAC SPAM THẤT BẠI')
...
def vietloan(sdt):
    ...
    try:
        if response ['status'] == 'success':
            print(f'[NC Hoài] ~ \033[1;35m VIETLOAN SPAM THÀNH CÔNG')
        else:
            print(f'[NC Hoài] ~ \033[1;35m VIETLOAN SPAM THẤT BẠI')
    except:
        print(f'[NC Hoài] ~ \033[1;35m VIETLOAN SPAM THẤT BẠI')
...
def viettel(sdt):
    ...
    try:
        if response ['errorCode'] == 0:
            print(f'[NC Hoài] ~ \033[1;35m VIETTEL SPAM THÀNH CÔNG')
        else:
            print(f'[NC Hoài] ~ \033[1;35m VIETTEL SPAM THẤT BẠI')
    except:
        print(f'[NC Hoài] ~ \033[1;35m VIETTEL SPAM THẤT BẠI')
...
def best(sdt):
    ...
    try:
        if response ['success'] == True:
            print(f'[NC Hoài] ~ \033[1;35m BEST-INC SPAM THÀNH CÔNG')
        else:
            print(f'[NC Hoài] ~ \033[1;35m BEST-INC SPAM THẤT BẠI')
    except:
        print(f'[NC Hoài] ~ \033[1;35m BEST-INC SPAM THẤT BẠI')
...
def emartmall(sdt):
    ...
    try:
        if response ['result'] == 'success':
            print(f'[NC Hoài] ~ \033[1;35m EMARTMALL SPAM THÀNH CÔNG')
        else:
            print(f'[NC Hoài] ~ \033[1;35m EMARTMALL SPAM THẤT BẠI')
    except:
        print(f'[NC Hoài] ~ \033[1;35m EMARTMALL SPAM THẤT BẠI')
...
def mutosi(sdt):
    ...
    try:
        if response ['status'] == 'error':
            print(f'[NC Hoài] ~ \033[1;35m MUTOSI SPAM THẤT BẠI')
        else:
            print(f'[NC Hoài] ~ \033[1;35m MUTOSI SPAM THÀNH CÔNG')
    except:
        print(f'[NC HoàiL] ~ \033[1;35m MUTOSI SPAM THÀNH CÔNG')
# \\ Vui lòng tôn trọng tác giả không xóa//
# /* Copyright © NC Hoài */
def vinamilk(sdt):
    cookies = {
    ...
    print(f'[NC Hoài] ~ \033[1;35m VINAMILK SPAM THÀNH CÔNG')
...
def vietair(sdt):
    ...
    try:
        if response ['TypeMsg'] == 1:
            print(f'[NC Hoài] ~ \033[1;35m VIETAIR SPAM THÀNH CÔNG')
        else:
            print(f'[NC Hoài] ~ \033[1;35m VIETAIR SPAM THẤT BẠI')
    except:
        print(f'[NC Hoài] ~ \033[1;35m VIETAIR SPAM THẤT BẠI')
...
def sapo(sdt):
    ...
    try:
        if response == True:
            print(f'[NC Hoài] ~ \033[1;35m SAPO SPAM THÀNH CÔNG')
        else:
            print(f'[NC Hoài] ~ \033[1;35m SAPO SPAM THẤT BẠI')
    except:
        print(f'[NC Hoài] ~ \033[1;35m SAPO SPAM THẤT BẠI')
